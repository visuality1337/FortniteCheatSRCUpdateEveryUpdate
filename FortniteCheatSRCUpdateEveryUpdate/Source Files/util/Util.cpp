...
namespace Util {
	...
	BOOLEAN Initialize() {
		...
		addr = FindPattern(xorstr("\x48\x8B\xC4\x48\x89\x58\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x0F\x29\x70\x00\x0F\x29\x78\x00\x44\x0F\x29\x40\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x45\x00\x45\x8A\xE9"), xorstr("xxxxxx?xxxxxxxxxxxxxxx?xxx????xxx?xxx?xxxx?xxx????xxxxxx?xxx"));
		if (!addr) {
