...
namespace Util {
	...
	BOOLEAN Initialize() {
		...
		auto addr = FindPattern("\x47\x65\x74\x4F\x75\x74\x65\x72\x4F\x62\x6A\x65\x63\x74\x00\x00\x47\x65\x74\x4F\x62\x6A\x65\x63\x74\x4E\x61\x6D\x65\x00\x00\x00", "xxxxxxxxxxxxxx??xxxxxxxxxxxxx???");
		if (!addr) {
