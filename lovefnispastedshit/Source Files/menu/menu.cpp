...
VOID EndScene(ImGuiWindow& window) {
	...
	if (ShowMenu) {
		...
		ImGui::GetStyle().FrameRounding = 4.0f;
			...
			ImGui::Begin("LoveFN is a big paste hahah cracked by Visual#9999", 0, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize); {
			...
			{
				ImGui::Text("LoveFNpaste Memory Aimbot paul was soooo stupid to fix memory so i do it : )");
				ToggleButton("LoveFNpaste Memory", &config_system.item.Aimbot);
				if (config_system.item.Aimbot)
				{
					ImGui::Text("LoveFNpaste Silent Aimbot");
					ToggleButton("LoveFNpaste Silent", &config_system.item.SilentAimbot);
					ImGui::Text("LoveFNpaste Trigger Aimbot");
					ToggleButton("LoveFNpaste Trigger", &config_system.item.TriggerAimbot);
					ImGui::Text("LoveFNpaste No Spread");
					ToggleButton("LoveFNpaste Spread", &config_system.item.NoSpreadAimbot);
				}
				const char* Points[] = { " Head", " Chest", " Pelvis" };
				static int AimPoint = 0;
				ImGui::Combo("LoveFNpaste Aim Point", &AimPoint, Points, IM_ARRAYSIZE(Points));
				config_system.item.AimPoint = AimPoint;
				if (config_system.item.AutoAimbot) {
					config_system.item.AutoAimbot = 2000.0f;
				}
				ImGui::Text("LoveFNpaste Fov");
				ToggleButton("LoveFNpaste Fov", &config_system.item.DrawAimbotFOV);
				if (config_system.item.DrawAimbotFOV)
				{
					ImGui::Text("LoveFNpaste Filled FOV");
					ToggleButton("LoveFNpaste Filled", &config_system.item.DrawFilledAimbotFOV);
				}
				ImGui::SliderFloat(("LoveFNpaste Circle FOV"), &config_system.item.AimbotFOV, 100.0f, 1000.0f);
			}

			if (ImGui::CollapsingHeader("LoveFNpaste Misc"))
			{
				ImGui::Text("LoveFNpaste Sniper Bullet TP paul was soooo stupid to fix memory so i do it : )");
				ToggleButton("LoveFNpaste Sniper", &config_system.item.BulletTP);

				ImGui::Text("LoveFNpaste Spin Bot [CAPSLOCK]");
				ToggleButton("LoveFNpaste Spin", &config_system.item.SpinBot);

				ImGui::Text("LoveFNpaste Check Visible");
				ToggleButton("LoveFNpaste Visible", &config_system.item.CheckVisible);

				ImGui::Text("LoveFNpasteCamera FOV");
				ToggleButton("LoveFNpaste Camera", &config_system.item.FOVSlider);

				if (config_system.item.FOVSlider)
				{
					ImGui::SliderFloat(("LoveFNpaste Camera FOV Slider"), &config_system.item.FOV, 0.0f, 150.0f, ("%.2f"));
				}
				ImGui::Text("LoveFNpaste Stream Snipe Player Name");
				ImGui::InputText("       ", streamsnipena, 256, ImGuiInputTextFlags_EnterReturnsTrue);
			}

			if (ImGui::CollapsingHeader("LoveFNpaste ESP"))
			{
				ImGui::Text("LoveFNpaste Chest ESP");
				ToggleButton("LoveFNpaste Chest", &config_system.item.Chest);
				ImGui::Text("LoveFNpaste Llama ESP");
				ToggleButton("LoveFNpaste Llama", &config_system.item.Llama);
				ImGui::Text("LoveFNpaste Ammo ESP");
				ToggleButton("LoveFNpaste Ammo", &config_system.item.Ammo);
				ImGui::Text("LoveFNpaste Boat ESP");
				ToggleButton("LoveFNpaste Boat", &config_system.item.boat);
				ImGui::Text("LoveFNpaste Chopper ESP");
				ToggleButton("LoveFNpaste Chopper", &config_system.item.chopper);
			}

			if (ImGui::CollapsingHeader("Colors"))
			{
				ImGui::PushItemWidth(100.0f);
				ImGui::Text("LoveFNpaste ESP");
				ImGui::SameLine();
				ImGui::ColorPicker3(("LoveFNpaste Box"), config_system.item.BoxESP, ImGuiColorEditFlags_NoInputs);
				ImGui::SameLine();
				ImGui::ColorPicker3(("LoveFNpaste Lines"), config_system.item.LineESP, ImGuiColorEditFlags_NoInputs);
				ImGui::SameLine();
				ImGui::ColorPicker3(("LoveFNpaste Aim\nFOV"), config_system.item.FOVCircleColor, ImGuiColorEditFlags_NoInputs);
				ImGui::Text("LoveFNpaste Skeleton ESP");
				ImGui::ColorPicker3(("LoveFNpaste Is\nVisible"), config_system.item.PlayerVisibleColor, ImGuiColorEditFlags_NoInputs);
				ImGui::SameLine();
				ImGui::ColorPicker3(("LoveFNpaste Not\nVisible"), config_system.item.PlayerNotVisibleColor, ImGuiColorEditFlags_NoInputs);
				ImGui::SameLine();
				ImGui::ColorPicker3(("LoveFNpaste Teammates"), config_system.item.PlayerTeammate, ImGuiColorEditFlags_NoInputs);
				ImGui::PopItemWidth();
				ImGui::SliderFloat(("LoveFNpaste Box Opacity"), &config_system.item.BoxESPOpacity, 0.0f, 1.0f, ("%.2f"));
				ImGui::SliderFloat(("LoveFNpaste FOV Circle Opacity"), &config_system.item.FOVCircleOpacity, 0.0f, 1.0f, ("%.2f"));
				ImGui::SliderFloat(("LoveFNpaste FOV Circle Filled Opacity"), &config_system.item.FOVCircleFilledOpacity, 0.0f, 1.0f, ("%.2f"));
			}
		}
		ImGui::End();
	}
